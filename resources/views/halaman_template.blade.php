...
<head>
    ...
    <title>TeamClean-Laundry</title>
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('icons/L1.png') }}">
...
<body>
    ...
    <div id="main-wrapper">
            ...
            <div align="center">
                <a href="{{ url('/dashboard') }}">
                    <span class="brand-title">
                        <img src="{{ asset('icons/L5.png') }}" width="150" alt="">
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                <img src="{{ asset('/pictures/' . auth()->user()->avatar ) }}" height="40" width="40" class="rounded-circle mr-3 fotouser">
                            </div>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ url('/kelola_outlet') }}" aria-expanded="false">
                            <i class="fa fa-shopping-bag menu-icon"></i><span class="nav-text">Kelola Outlet</span>
                        </a>
                    </li>
                    
                    <li>
                        <a href="{{ url('/kelola_paket') }}" aria-expanded="false">
                            <i class="fa fa-list-alt menu-icon"></i><span class="nav-text">Kelola Paket</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/kelola_pengguna') }}" aria-expanded="false">
                            <i class="fa fa-user-plus menu-icon"></i><span class="nav-text">Kelola Pengguna</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-label">Layanan Laundry</li>
                    <li>
                        <a href="{{ url('/registrasi_pelanggan') }}" aria-expanded="false">
                            <i class="fa fa-address-card-o menu-icon" aria-hidden="true"></i><span class="nav-text">Registrasi Pelanggan</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/kelola_pelanggan') }}" aria-expanded="false">
                            <i class="fa fa-users menu-icon" aria-hidden="true"></i><span class="nav-text">Kelola Pelanggan</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/kelola_transaksi') }}" aria-expanded="false">
                            <i class="fa fa-handshake-o menu-icon" aria-hidden="true"></i><span class="nav-text">Transaksi</span>
                        </a>
                    </li>
                    @endif
        ...
        <div class="footer">
            <div class="copyright">
                <p>Jasa Website Terjangaku &copy; Permana Sidik </a> 2021</p>
            </div>
        </div>
    </div>
