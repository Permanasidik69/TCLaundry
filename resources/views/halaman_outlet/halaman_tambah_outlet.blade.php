                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{ url('/simpan_outlet') }}" method="post" name="outlet_baru_form">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="val-hotline">No Telepon <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-hotline" name="hotline" placeholder="Masukkan No Telepon">
                                </div>
                            </div>
                            <div class="form-group row">
